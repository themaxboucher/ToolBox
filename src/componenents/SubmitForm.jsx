  ...
  return (
    <Card>
      <div className={classes.heading}>
        <h1><SparklesIcon /><span>Submit an AI tool</span></h1>
        <p>
          Know of a great AI tool we're missing? Built one yourself? Submit it
          below.
        </p>
      </div>
      <form className={classes.form} onSubmit={submitHandler}>
        ...
        <div className={classes.control}>
          <label htmlFor="thumbnail">
            ...
            <span className={classes.sublabel}>Please provide a valid URL</span>
          </label>
          <input
            type="url"
            id="thumbnail"
        ...
        <div className={classes.control}>
          ...
          <div
            className={!enteredFree ? classes.option : classes.selectedOption}
          ...
          <div
            className={!enteredPaid ? classes.option : classes.selectedOption}
        ...
        <button className="btn"><SparklesIcon /><span>Submit Tool</span></button>
      </form>
    </Card>
  );
}
